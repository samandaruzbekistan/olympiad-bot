    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed inset-y-0 left-0 z-40 w-64 flex flex-col border-r border-slate-200 bg-white shadow-sm lg:static lg:translate-x-0">
            <div class="flex h-16 shrink-0 items-center gap-2 border-b border-slate-200 px-6">
                ...
                <span class="text-lg font-semibold text-slate-800">Olympiad Admin</span>
            </div>
            <nav class="flex-1 space-y-0.5 overflow-y-auto px-3 py-4">
                ...
                <a href="{{ route('admin.payments.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium {{ request()->routeIs('admin.payments.*') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
